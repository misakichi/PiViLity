...
namespace PiViLity.Controls
{
    public class FileListViewApp : PiViLityCore.Controls.FileListView
    {
        ...
        /// </summary>
        public bool CanPreviousDirectoryEnabled => _currentRecentIndex > 0;

        /// <summary>
        /// Gets a value indicating whether the next directory in the recent directory list is available.
        /// </summary>
        public bool CanNextDirectoryEnabled => _currentRecentIndex < _directoryRecent.Count - 1;

        /// <summary>
        /// Gets a value indicating whether the parent directory of the specified path exists.
        /// </summary>
        public bool CanParentDirectoryEnabled => (new DirectoryInfo(Path)).Parent != null;
        ...
        {
            //ボタンの有効無効状態を得ておく
            bool preIsPreviousEnabled = CanPreviousDirectoryEnabled;
            bool preIsNextEnabled = CanNextDirectoryEnabled;
            bool preIsParentEnabled = CanParentDirectoryEnabled;
            ...
            //ボタンの有効無効を更新
            if (preIsPreviousEnabled != CanPreviousDirectoryEnabled || preIsNextEnabled != CanNextDirectoryEnabled || preIsParentEnabled != CanParentDirectoryEnabled)
            {
