...
namespace PiViLity.Reader
{
    ...
    public class ImageReaderWIC : ImageReaderBase
    {
        ...
        public override System.Drawing.Image? GetImage()
        {
            ...
            switch (imageData.Format)
            {
                ...
                case DXGI_FORMAT.B5G5R5A1_UNORM:
                    return new System.Drawing.Bitmap(imageData.Width, imageData.Height, (int)imageData.RowPitch, System.Drawing.Imaging.PixelFormat.Format16bppArgb1555, imageData.Pixels);
                default:
                    imageData = scratchImage.Convert(DXGI_FORMAT.B8G8R8A8_UNORM, TEX_FILTER_FLAGS.DEFAULT, 0.5f).GetImage(0);
                    return new System.Drawing.Bitmap(imageData.Width, imageData.Height, (int)imageData.RowPitch, System.Drawing.Imaging.PixelFormat.Format32bppArgb, imageData.Pixels);
            }
        ...
        public override System.Drawing.Image? GetThumbnailImage(System.Drawing.Size size)
        {
            ...
            var helper = TexHelper.Instance;
            using (var scratchImage = helper.LoadFromWICFile(filePath, WIC_FLAGS.FILTER_POINT))
            {
                if (scratchImage == null)
                {
                    return null;
                }
                var thumbnailImage = scratchImage;
                ...
                var img = helper.Initialize2D(DirectXTexNet.DXGI_FORMAT.B8G8R8A8_UNORM, size.Width, size.Height, 1, 1, DirectXTexNet.CP_FLAGS.NONE);
                {
                    var finalImage = img.GetImage(0);
                    ...
                    if (ThumbnailType == ThumbnailTypes.KeepAspectRatio)
                    {
                        ...
                        var resizedImage = thumbnailImage.Resize(0, newWidth, newHeight, TEX_FILTER_FLAGS.POINT);
                    ...
                    return new System.Drawing.Bitmap(finalImage.Width, finalImage.Height, (int)finalImage.RowPitch, System.Drawing.Imaging.PixelFormat.Format32bppArgb, finalImage.Pixels);
                }
            }
        }
